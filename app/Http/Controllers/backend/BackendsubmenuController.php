...
class BackendsubmenuController extends Controller
{
    ...
    public function index()
    {
        ...
        $data = BackendSubMenubar::where('menu_id', $menu_id)->get();
        return view('backend.backendsubmenu.index', compact('data'));
    }
    ...
    public function create()
    {
        ...
        return view('backend.backendsubmenu.form', compact('menu_list'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect('admin/backendsubmenu?menu_id=' . $menu_id);
    }
    ...
    {
        $data = BackendSubMenubar::findOrFail($id);
        $backendmenu = BackendMenubar::get();
        $menu_list = collect($backendmenu)->mapWithKeys(function ($item, $key) {
            return [$item['menu_id'] => $item['menu_name']];
        });
        return view('backend.backendsubmenu.form', compact('data', 'menu_list'));
    }
    ...
    public function update(Request $request)
    {
        ...
        if ($request->submenu_permissions) {
            $base_submenu_permissions = BasePermission::all();
            ...
            $submenu_permissions = Permission::where('base_permission_id', $request->base_permission_id)->where('menu_id', $request->menu_id)->where('submenu_id', $request->submenu_id)->get(); //Match input //permission to db record
            if ($submenu_permissions) {
    ...
    public function destroy($id)
    {
        ...
        return redirect('admin/backendsubmenu?menu_id=' . $backendsubmenu->menu_id);
    }
}
