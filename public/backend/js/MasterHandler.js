    ...
    initialize() {
        ...
        $(self.inputField).on("select2:open", function () {
            ...
            if (!modalOpenBound) {
                ...
                brandOptions.$results
                    .parents(".select2-results")
                    .append(
                        `<div class="m-2 select2-link2 select2-close text-right"><button class="btn btn-secondary open_modal " data-id="${self.addModal}">Add New Item +</button></div>`
                    );
